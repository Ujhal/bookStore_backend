...
from .views import OrderAPIView, CheckoutRegisterAPIView,OrderDetailAPIView, OrderItemAPIView, OrderCancelAPIView, AdminOrderStatusUpdateAPIView,PublisherSubOrderListAPIView,PublisherSubOrderUpdateAPIView,AdminOrderListAPIView,AdminOrderByStatusAPIView,PublisherSubOrderByStatusAPIView,SubOrderDetailAPIView,OrderCustomerAPIView,UserOrderDetailAPIView,OrderAdminAPIView

urlpatterns = [
    # Orders
    path('orders/', OrderAPIView.as_view(), name='order-list-create'),
    path('orders/customer/', OrderCustomerAPIView.as_view(), name='order-list-create'),
    ...
    path('user/orders/<int:pk>/', UserOrderDetailAPIView.as_view(), name='user-order-detail'),
