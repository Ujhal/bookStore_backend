...
SECRET_KEY = 'django-insecure-64mj+7u2pf!md7e%loy%2(6dabho05fj0=#flbp26wr@_0iyci'
...
AUTHENTICATION_BACKENDS = [
    'accounts.auth_backend.CustomAuthenticationBackend',  # Use your custom backend
    'django.contrib.auth.backends.ModelBackend',  # Default backend to fall back on
]
...
RAZORPAY_KEY_ID = "rzp_live_SPPQjI4f82gz3s"
RAZORPAY_KEY_SECRET = "lufr65bXPo4AVOVITbbyTOVu"
